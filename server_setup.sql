...
-- Add created_date column with default current timestamp
ALTER TABLE games ADD COLUMN thumbnail TEXT DEFAULT NULL;
...
CREATE TABLE user_settings (
    ...
    use_cookies BOOLEAN DEFAULT false,
    custom_setting1 VARCHAR(100),
    custom_setting2 VARCHAR(100),
    -- More custom settings placeholders
